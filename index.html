...
<body>
    <header class="header">
        ...
        <div class="header-login">
            <a hred="#" class="header-login_btn btn-login">Login</a>
            <a hred="#" class="header-sign_btn btn-login">sign in</a>
            <button class="header-plan_btn btn-login">chose plan</button>
        </div>
    </header>
   <div class="banner">
       <div class="container">
           <div class="banner-wrap">
               <h1 class="banner__headtext">make your body <br> <span>beautiful</span></h1>
               <p class="banner__text">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
               <button class="banner__btn btn-design">get in Touch</button>
           </div>
       </div>
   </div>
   <div class="container">
        <section class="booking">
            ...
            <form action="" class="booking-form">
                <h1 class="booking__text">free 7 days</h1>
                <h2 class="booking__subtext">online booking</h2>
                <input type="number" name="people" placeholder="3 People">
                <input type="date" name="date" placeholder="Date">
                <input type="time" name="time" placeholder="time">  <br>
                <input type="text" name="Name" placeholder="Name">
                <input type="tel" name="phone" placeholder="Phone">
                <input type="email" name="mail" placeholder="Email"> <br>
                <input type="button" class="btn-design" value="get in touch">
            </form>  
        </section>
   </div>
   <section class="about">
        ...
        <div class="container">
            <div class="about-text">
                    <h1 class="about__headtext">welcome to <span>fitness</span></h1>
                    <h2 class="about__subheadtext">
                        Lorem ipsum dolor sit amet consectetur 
                        adipisicing elit. Cum ad aliquam sapiente! Est laudantium neque eius,
                         numquam ut repellat error ducimus mollitia.
                    </h2>
                    <p class="about__text">
                        Lorem ipsum dolor sit amet consectetur adipisicing 
                        elit. Nesciunt autem totam non dolor dolorum porro alias aspernatur cumque 
                        inventore eveniet. Eveniet labore adipisci neque ad, corrupti tempore blanditiis
                         sint molestiae!
                    </p>
                    <button class="about__btn btn-design">get in touch</button>
            </div>
    ...
    <section class="programm">
        <div class="container">
            <div class="programm-textbox">
                <h1 class="about__headtext">welcome to <span>fitness</span></h1>
                <p class="programm-textbox__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus, accusantium.</p>
            </div>
    ...
    <section class="content">
        <div class="content-text">
            <h2 class="content-text__title">
                we trained with <br>  <span>personal trainer</span>
            </h2>
            <button class="content-text__btn btn-design">get in touch</button>
        </div>
    </section>
    <section class="trainers">
        <div class="container">
            <div class="trainers-textbox">
                <h1 class="about__headtext">Expert <span> trainers</span></h1>
                <p class="trainers-textbox__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus, accusantium.</p>
            </div>
    ...
    <section class="media">
        <div class="media-bg-left">
            <div class="media-infobox">
                <h2 class="media-infobox__title">try for free</h2>
                <h3 class="media-infobox__subtitle">free 5 days pass</h3>
                <button class="media-boxinfo__btn btn-design">get in touch</button>
            </div>
        </div>
        <div class="media-bg-right">
            <div class="media-infobox">
                <h2 class="media-infobox__title">call us and try</h2>
                <h3 class="media-infobox__subtitle">957 547 4545</h3>
                <button class="media-infobox__btn btn-design">get in touch</button>
    ...
    <footer class="footer">
        <div class="container footer-flexbox">
            <section class="footer-info">
                        <h2 class="footer-info__title">fitne<span>ss</span></h2>
                        ...
                        <form action="post" class="footer-form">
                            ...
                            <input type="submit" value="subscribe" class="btn-design footer-form__btn"> 
                        </form>
            </section>
        ...
        <span class="footer__copy">&copy 2018 free-PSD-template</span>
    </footer>
